...
void loadShadowShader()
{
	...
	vertexShaderHandle   = loadShader("VertexShader.vs",GL_VERTEX_SHADER);
	fragmentShaderHandle = loadShader("FragmentShader.fs",GL_FRAGMENT_SHADER);
	...
	vertexShaderHandle   = loadShader("StoreDepthVertexShader.vs",GL_VERTEX_SHADER);
	fragmentShaderHandle = loadShader("StoreDepthFragmentShader.fs",GL_FRAGMENT_SHADER);
	...
	vertexShaderHandle   = loadShader("BlurVertexShader.vs",GL_VERTEX_SHADER);
	fragmentShaderHandle = loadShader("BlurFragmentShader.fs",GL_FRAGMENT_SHADER);
